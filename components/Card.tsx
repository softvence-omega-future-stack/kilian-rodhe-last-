  ...
  return (
    <div className="bg-white overflow-hidden overflow-x-hidden lg:mb-30 font-['Cormorant_Garamond'] h-[660px]">
      ...
      >
        ...
        {/* Trending badge - keeping this static for simplicity */}
        {tranding === 1 && (
        ...
        {/* ADDED: content-slide-up class for the main slide-up animation */}
      ...
      {ageValue && (
        ...
        inline-block w-[100] h-[16px]"
          ...
          <div className="grid grid-cols-2 gap-2 w-full">
            {/* ADDED: Staggered animation classes to the age buttons */}
            {["18-25", "26-35", "36-50", "50+"].map((age, index) => (
              <button
                key={age}
