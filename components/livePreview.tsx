...
/**
 * Renders the AI Design generation panel.
 * @param {object} props
 * @param {function} props.onPreviewClick - Function to open the preview modal.
 */

// --- Main Component ---
const CombinedDesignPageFixed = () => {
  // 🔑 KEY: New state to manage the active design mode: 'ai' or 'text'
        ...
        >
          ...
          >
            <div className="space-y-6 border border-[#E5E5E5] p-4 rounded-md">
              ...
              <div className="flex justify-between mt-6 gap-2 pt-4 border-t border-gray-100">
                <div
                ...
                <div className="flex flex-col items-center text-center p-3 bg-[#F5F5F5] text-[12px]  px-2 w-1/2">
                  <p
                    className="leading-tight text-[#6B6B6B]"
                    style={{
                      fontFamily: "'Jost', sans-serif",
                      letterSpacing: "0.5px",
                    }}
                  >
                    ↩️ 30-day returns <br /> money-back guarantee
                  </p>
                </div>
              </div>
            </div>
